...
export const uploadContactoImage = createCloudinaryUploader(
    process.env.CLOUDINARY_FOLDER || 'agendaWeb/contactos'
);
 
// Uploader para imágenes de Equipos deportivos

/*export const uploadTeamImage = createCloudinaryUploader(
    process.env.CLOUDINARY_TEAMS_FOLDER || 'agendaWeb/teams'
);
